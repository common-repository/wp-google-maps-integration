...
window.Colors = function(a, b) {
        ...
        q.prototype.setColor = function(a, d, f) {
            return s(this), a ? c(this.colors, a, d, b, f) : (f !== b && (this.colors.alpha = k(f, 0, 1)), e(d))
    ...
    function(a, b, c, d) {
        ...
        function g(a) {
            return b(a.find(s.doRender)[0] || a[0])
        }
        ...
        function h(c) {
            var d = b(this),
                ...
                h = b(a),
                j = s.gap;
            c ? (t = g(d), t._colorMode = t.data("colorMode"), q.$trigger = d, (u || i()).css({
                left: (u[0]._left = f.left) - ((u[0]._left = u[0]._left + u[0]._width - (h.scrollLeft() + h.width())) + j > 0 ? u[0]._left + j : 0),
                top: (u[0]._top = f.top + d.outerHeight()) - ((u[0]._top = u[0]._top + u[0]._height - (h.scrollTop() + h.height())) + j > 0 ? u[0]._top + j : 0)
            }).show(s.animationSpeed, function() {
                c !== !0 && (y._width = y.width(), v._width = v.width(), v._height = v.height(), r.setColor(e(t[0])), n(!0))
            })) : b(u).hide(s.animationSpeed, function() {
                t.blur(), n(!1), q.$trigger = null
            })
        }

        function i() {
            return b("head").append('<style type="text/css">' + (s.css || J) + (s.cssAddon || "") + "</style>"), q.$UI = u = b(I).css({
                margin: s.margin
            }).appendTo("body").show(0, function() {
                var a = b(this);
                F = s.GPU && a.css("perspective") !== d, v = b(".cp-xy-slider", this), w = b(".cp-xy-cursor", this), x = b(".cp-z-cursor", this), y = b(".cp-alpha", this).toggle(!!s.opacity), z = b(".cp-alpha-cursor", this), s.buildCallback.call(q, a), a.prepend("<div>").children().eq(0).css("width", a.children().eq(0).width()), this._width = this.offsetWidth, this._height = this.offsetHeight
            }).hide().on(D, ".cp-xy-slider,.cp-z-slider,.cp-alpha", j)
        }

        function j(a) {
            var c = this.className.replace(/cp-(.*?)(?:\s*|$)/, "$1").replace("-", "_");
            a.preventDefault && a.preventDefault(), a.returnValue = !1, t._offset = b(this).offset(), (c = "xy_slider" === c ? k : "z_slider" === c ? l : m)(a), n(), A.on(E, function() {
                A.off(".a")
            }).on(C, function(a) {
                c(a), n()
            })
        ...
        function m(a) {
            var b = f(a).pageX - t._offset.left,
                c = b / y._width;
            r.setColor({}, "rgb", c)
        }
        ...
        function n(a) {
            var b = r.colors,
                ...
                B = F ? "translate3d" : "",
                C = t[0].value,
                D = t[0].hasAttribute("value") && "" === C && a !== d;
            v._css = {
            ...
            }, t.text = D ? "" : C !== m ? m : "", a !== d ? o(a) : H(o)
        }

        function o(a) {
            v.css(v._css), w.css(w._css), x.css(x._css), y.css(y._css), z.css(z._css), s.doRender && t.css(t._css), t.text && t.val(t.text), s.renderCallback.call(q, t, "boolean" == typeof a ? a : d)
        }
        var p, q, r, s, t, u, v, w, x, y, z, A = b(document),
            B = "",
            C = "touchmove.a mousemove.a pointermove.a",
            D = "touchstart.a mousedown.a pointerdown.a",
            E = "touchend.a mouseup.a pointerup.a",
            F = !1,
            G = Math.round,
            H = a.requestAnimationFrame || a.webkitRequestAnimationFrame || function(a) {
                a()
            },
            I = '<div class="cp-color-picker"><div class="cp-z-slider"><div class="cp-z-cursor"></div></div><div class="cp-xy-slider"><div class="cp-white"></div><div class="cp-xy-cursor"></div></div><div class="cp-alpha"><div class="cp-alpha-cursor"></div></div></div>',
            J = ".cp-color-picker{position:absolute;overflow:hidden;padding:6px 6px 0;background-color:#3f3f3f;color:#bbb;box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.3);font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:400;cursor:default;border-radius:5px}.cp-color-picker>div{position:relative;overflow:hidden}.cp-xy-slider{float:left;height:128px;width:128px;margin-bottom:6px;background:linear-gradient(to right,#FFF,rgba(255,255,255,0))}.cp-white{height:100%;width:100%;background:linear-gradient(rgba(0,0,0,0),#000)}.cp-xy-cursor{position:absolute;top:0;width:10px;height:10px;margin:-5px;border:1px solid #fff;border-radius:100%;box-sizing:border-box}.cp-z-slider{float:right;margin-left:6px;height:128px;width:20px;background:linear-gradient(red 0,#f0f 17%,#00f 33%,#0ff 50%,#0f0 67%,#ff0 83%,red 100%)}.cp-z-cursor{position:absolute;margin-top:-4px;width:100%;border:4px solid #fff;border-color:transparent #fff;box-sizing:border-box}.cp-alpha{clear:both;width:100%;height:16px;margin:6px 0;background:linear-gradient(to right,#444,rgba(0,0,0,0))}.cp-alpha-cursor{position:absolute;margin-left:-4px;height:100%;border:4px solid #fff;border-color:#fff transparent;box-sizing:border-box}",
            K = function(a) {
                r = this.color = new c(a), s = r.options
            };
        return K.prototype = {
            render: n,
            toggle: h
            ...
            return c = b.extend({
                ...
                scrollResize: !0,
                gap: 4
            }, c), !q && c.scrollResize && b(a).on("resize.a scroll.a", function() {
                q.$trigger && q.toggle.call(q.$trigger[0], !0)
            }), p = p ? p.add(this) : this, p.colorPicker = q || (q = new K(c)), B += (B ? ", " : "") + this.selector, b(c.body).off(".a").on(D, function(a) {
                var c = b(a.target); - 1 !== b.inArray(c.closest(B)[0], p) || c.closest(u).length || p.colorPicker.$trigger && h()
            }).on("focusin.a click.a", B, h).on("change.a", B, function() {
                r.setColor(this.value || "#FFF"), p.colorPicker.render(!0)
            }), this.each(function() {
                var a = e(this),
                    d = a.split("("),
                    f = g(b(this));
                f.data("colorMode", d[1] ? d[0].substr(0, 3) : "HEX").attr("readonly", s.preventFocus), c.doRender && f.css({
                    "background-color": a,
                    color: function() {
                        return r.setColor(a).rgbaMixBGMixCustom.luminance > .22 ? "#222" : "#ddd"
                    }
                })
            })
        }, b.fn.colorPicker.destroy = function() {
            b(q.color.options.body).off(".a"), q.toggle(!1), p = null, B = ""
        }, b
